...
public class customerGroupsWithOutStandingBalance extends TestListenerAdapter {
	...
	@Test(priority = 1, description = "Open 'Customer Groups with Outstanding Balance' list screen")
	public void Open_customerGroupsWithOutStandingBalance_Listscreen() {
		driver = WebDriverManager.getDriverInstance();
		CG_screen = new CustomeGroupsListScreenPage(driver);
		String ExpectedResult = CG_screen.OpenCustomerGroupsListScreen(ListScreenLocators.CG_outstandingInv);
		CG_screen.ValidateOpenedListScreen(ExpectedResult, "Customer groups with outstanding balance");
	}

	@Test(priority = 2, description = "Open Customer Report in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 3, description = "Open Export to Excel in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 4, description = "Open Advance Search in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 5, description = "Open Customer Information Screen in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 6, description = "Open Customer Details in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 7, description = "Open Customer Contacts in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 8, description = "Open Make Note in 'Customer Groups with Outstanding Balance' list screen without debtor selection"
	...
	@Test(priority = 9, description ="Open Committed Payments in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 11, description ="Open Payment Scheme in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 12, description ="Open Register Dispute in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 13, description ="Open Create Request Action in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 14, description =
	  "Open Block Customer in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 15, description ="Open Unblock Customer in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 16, description ="Open Notes History in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	public void Open_NotesHistory() {
	  ...
	  @Test(priority = 17, description = "Open Committed Payment History in 'Customer Groups with Outstanding Balance' list screen without debtor selection"
	  ) 
	  ...
	  @Test(priority = 18, description ="Open Payment Schemes History in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 19, description ="Open Disputes History in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 20, description ="Open Dunning Letter History in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 21, description ="Open Email History in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 22, description ="Open SMS History in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 23, description ="Open List of Outstanding Invoices in 'Customer Groups with Outstanding Balance' list screen without debtor selection") 
	...
	@Test(priority = 24, description = "Open List of Invoices Paid in 'Customer Groups with Outstanding Balance' list screen without debtor selection") 
	...
	@Test(priority = 25, description ="Open Customer User Fields in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	public void Open_CustomerUserFields() {
	  ...
	  @Test(priority = 26, description ="Open Assign Customer Properties in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 27, description ="Open Customer Groups in 'Customer Groups with Outstanding Balance' list screen without debtor selection")
	...
	@Test(priority = 28, description ="Open Help Page in 'Customer Groups with Outstanding Balance' list screen without debtor selection") 
	...
	@Test(priority = 29, description = "Open Customer Report in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 30, description = "Open Export to Excel in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 31, description = "Open Advance Search in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 32, description = "Open Customer Information Screen in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 33, description = "Open Customer Details in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 34, description = "Open Customer Contacts in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 35, description ="Open Make Note in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 36, description =
	  "Open Committed Payments in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 37, description = "Open Payment Scheme in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 38, description = "Open Register Dispute in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 39, description = "Open Create Request Action in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 40, description = "Open Block Customer in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 41, description = "Open Unblock Customer in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 42, description = "Open Notes History in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 43, description = "Open Committed Payment History in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 44, description = "Open Payment Schemes History in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 45, description = "Open Disputes History in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 46, description = "Open Dunning Letter History in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 47, description = "Open Email History in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 48, description = "Open SMS History in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 49, description = "Open List of Outstanding Invoices in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 50, description = "Open List of Invoices Paid in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 51, description = "Open Customer User Fields in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 52, description = "Open Assign Customer Properties in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 53, description = "Open Customer Groups in 'Customer Groups with Outstanding Balance' list screen with debtor selection")
	...
	@Test(priority = 54, description = "Close 'Customer Groups with Outstanding Balance' list screen")
	public void Close_customerGroupsWithOutStandingBalance_Listscreen() {
		CG_screen.CloseAllCustomerGroupListScreen();
	}
