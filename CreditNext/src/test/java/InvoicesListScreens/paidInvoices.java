...
public class paidInvoices extends TestListenerAdapter {
	WebDriver driver;
	...
	@Test(priority = 1, description = "Open 'Paid Invoices' list screen")
	public void Open_PaidInvoices_List_screen() {
		driver = WebDriverManager.getDriverInstance();
		CG_screen = new CustomeGroupsListScreenPage(driver);
		String ExpectedResult = CG_screen.OpenCustomerGroupsListScreen(ListScreenLocators.paidInvoices);
		CG_screen.ValidateOpenedListScreen(ExpectedResult, "Paid Invoices");
	}
	@Test(priority = 2, description = "Open Invoice Report in 'Paid Invoices' list screen without invoice selection")
	public void Open_InvoiceReport_In_paid_Invoices_List_screen() {
	...
	@Test(priority = 3, description = "Open Export to Excel in 'Paid Invoices' list screen without invoice selection")
	public void Open_ExporttoExcel_In_paid_Invoices_List_screen() {
	...
	@Test(priority = 4, description = "Open Advance Search in 'Paid Invoices' list screen without invoice selection")
	public void Open_AdvanceSearch_In_paid_Invoices_List_screen() {
	...
	@Test(priority = 5, description = "Open Invoice Information Screen in 'Paid Invoices' list screen without invoice selection")
	public void Open_CIS_In_paid_Invoices_List_screen() {
	...
	@Test(priority = 6, description = "Open Invoice Details in 'Paid Invoices' list screen without invoice selection")
	public void Open_InvoiceDetails_In_paid_Invoices_List_screen() {
	...
	@Test(priority = 7, description = "Open Make Note in 'Paid Invoices' list screen without invoice selection")
	public void Open_MakeNote_In_paid_Invoices_List_screen() { String
	...
	@Test(priority = 8, description ="Open Committed Payments in 'Paid Invoices' list screen without invoice selection")
	public void Open_CommittedPayments_In_paid_Invoices_List_screen() {
	...
	@Test(priority = 9, description ="Open Payment Scheme in 'Paid Invoices' list screen without invoice selection")
	public void Open_PaymentScheme_In_paid_Invoices_List_screen() {
	...
	@Test(priority = 10, description ="Open Register Dispute in 'Paid Invoices' list screen without invoice selection")
	public void Open_RegisterDispute_In_paid_Invoices_List_screen() {
	...
	@Test(priority = 11, description ="Open Notes History in 'Paid Invoices' list screen without invoice selection")
	public void Open_NotesHistory_In_paid_Invoices_List_screen() {
	...
	@Test(priority = 12, description = "Open Committed Payment History in 'Paid Invoices' list screen without invoice selection") 
	public void Open_CommittedPaymentHistory_In_paid_Invoices_List_screen() { 
	...
	@Test(priority = 13, description ="Open Payment Schemes History in 'Paid Invoices' list screen without invoice selection")
	public void Open_PaymentSchemesHistory_In_paid_Invoices_List_screen() { 
	...
	@Test(priority = 14, description ="Open Disputes History in 'Paid Invoices' list screen without invoice selection")
	public void Open_DisputeHistory_In_paid_Invoices_List_screen() {
	...
	@Test(priority = 15, description ="Open Invoice User Fields in 'Paid Invoices' list screen without invoice selection")
	public void Open_InvoiceUserFields_In_paid_Invoices_List_screen() {
	...
	@Test(priority = 16, description ="Open Assign Invoice Properties in 'Paid Invoices' list screen without invoice selection")
	public void Open_AssignInvoiceProperties_In_paid_Invoices_List_screen() { 
	...
	@Test(priority = 18, description ="Open partials payments in 'Paid Invoices' list screen without invoice selection")
	public void Open_showPartialPayment_In_paid_Invoices_List_screen() {
	...
	@Test(priority = 19, description ="Open Invoice total in 'Paid Invoices' list screen without invoice selection")
	public void Open_InvoiceTotal_In_paid_Invoices_List_screen() {
	...
	@Test(priority = 22, description = "Open Export to Excel in 'Paid Invoices' list screen with invoice selection")
	public void Open_ExporttoExcel_with_PaidInvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 23, description = "Open Advance Search in 'Paid Invoices' list screen with invoice selection")
	public void Open_AdvanceSearch_with_PaidInvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 24, description = "Open Invoice Information Screen in 'Paid Invoices' list screen with invoice selection")
	public void Open_CIS_with_PaidInvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 25, description = "Open Invoice Details in 'Paid Invoices' list screen with invoice selection")
	public void Open_InvoiceDetails_with_PaidInvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 26, description = "Open Make Note in 'Paid Invoices' list screen with invoice selection")
	public void Open_MakeNote_with_PaidInvoiceSelection() { 
		 CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 27, description ="Open Committed Payments in 'Paid Invoices' list screen with invoice selection")
	public void Open_CommittedPayments_with_PaidInvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 28, description ="Open Payment Scheme in 'Paid Invoices' list screen with invoice selection")
	public void Open_PaymentScheme_with_PaidInvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 29, description ="Open Register Dispute in 'Paid Invoices' list screen with invoice selection")
	public void Open_RegisterDispute_with_PaidInvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 30, description ="Open Notes History in 'Paid Invoices' list screen with invoice selection")
	public void Open_NotesHistory_with_PaidInvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	  ...
	  @Test(priority = 31, description = "Open Committed Payment History in 'Paid Invoices' list screen with invoice selection") 
	  public void Open_CommittedPaymentHistory_with_PaidInvoiceSelection() { 
		  CG_screen.selectDebtorinListScreen(InvNum);
	  ...
	  @Test(priority = 32, description ="Open Payment Schemes History in 'Paid Invoices' list screen with invoice selection")
	  public void Open_PaymentSchemesHistory_with_PaidInvoiceSelection() { 
		  CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 33, description ="Open Disputes History in 'Paid Invoices' list screen with invoice selection")
	public void Open_DisputeHistory_with_PaidInvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 34, description ="Open Invoice User Fields in 'Paid Invoices' list screen with invoice selection")
	public void Open_InvoiceUserFields_with_PaidInvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	 ...
	 @Test(priority = 35, description ="Open Assign Invoice Properties in 'Paid Invoices' list screen with invoice selection")
	 public void Open_AssignInvoiceProperties_with_PaidInvoiceSelection() throws InterruptedException { 
	...
	public void Open_showPartialPayment_with_PaidInvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 38, description ="Open Invoice totals in 'Paid Invoices' list screen with invoice selection")
	public void Open_InvoiceTotal_with_PaidInvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 39, description = "Close 'Paid Invoices'list screen")
	public void Close_PaidInvoicesListscreen() {
		CG_screen.CloseAllCustomerGroupListScreen();
	}
