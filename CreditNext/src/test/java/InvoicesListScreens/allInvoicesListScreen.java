...
public class allInvoicesListScreen extends TestListenerAdapter {
	WebDriver driver = null;
	CustomeGroupsListScreenPage CG_screen = null;
	String noRowsSelected = "You must select at least one row";
	String InvNum = "2012APU0000063200004";

	@Test(priority = 1, description = "Open 'All Invoices' list screen")
	public void Open_allInvoicesListScreen() {
		driver = WebDriverManager.getDriverInstance();
		CG_screen = new CustomeGroupsListScreenPage(driver);
		CG_screen.ClickCustomerGroupMenuItem(ListScreenLocators.InvoicesMenuItems);// Open Invoices List screen
		String ExpectedResult = CG_screen.OpenCustomerGroupsListScreen(ListScreenLocators.allInvoices);
		CG_screen.ValidateOpenedListScreen(ExpectedResult, "All invoices");
	}

 	@Test(priority = 2, description = "Open Invoice Report in 'All Invoices' list screen without invoice selection")
	public void Open_InvoiceReport_In_All_Invoices_List_screen() {
	...
	@Test(priority = 3, description = "Open Export to Excel in 'All Invoices' list screen without invoice selection")
	public void Open_ExporttoExcel_In_All_Invoices_List_screen() {
	...
	@Test(priority = 4, description = "Open Advance Search in 'All Invoices' list screen without invoice selection")
	public void Open_AdvanceSearch_In_All_Invoices_List_screen() {
	...
	@Test(priority = 5, description = "Open Invoice Information Screen in 'All Invoices' list screen without invoice selection")
	public void Open_CIS_In_All_Invoices_List_screen() {
	...
	@Test(priority = 6, description = "Open Invoice Details in 'All Invoices' list screen without invoice selection")
	public void Open_InvoiceDetails_In_All_Invoices_List_screen() {
	...
	@Test(priority = 7, description = "Open Make Note in 'All Invoices' list screen without invoice selection")
	public void Open_MakeNote_In_All_Invoices_List_screen() { String
	...
	@Test(priority = 8, description ="Open Committed Payments in 'All Invoices' list screen without invoice selection")
	public void Open_CommittedPayments_In_All_Invoices_List_screen() {
	...
	@Test(priority = 9, description ="Open Payment Scheme in 'All Invoices' list screen without invoice selection")
	public void Open_PaymentScheme_In_All_Invoices_List_screen() {
	...
	@Test(priority = 10, description ="Open Register Dispute in 'All Invoices' list screen without invoice selection")
	public void Open_RegisterDispute_In_All_Invoices_List_screen() {
	...
	@Test(priority = 11, description ="Open Notes History in 'All Invoices' list screen without invoice selection")
	public void Open_NotesHistory_In_All_Invoices_List_screen() {
	...
	@Test(priority = 12, description = "Open Committed Payment History in 'All Invoices' list screen without invoice selection") 
	public void Open_CommittedPaymentHistory_In_All_Invoices_List_screen() { 
	...
	@Test(priority = 13, description ="Open Payment Schemes History in 'All Invoices' list screen without invoice selection")
	public void Open_PaymentSchemesHistory_In_All_Invoices_List_screen() { 
	...
	@Test(priority = 14, description ="Open Disputes History in 'All Invoices' list screen without invoice selection")
	public void Open_DisputeHistory_In_All_Invoices_List_screen() {
	...
	@Test(priority = 15, description ="Open Invoice User Fields in 'All Invoices' list screen without invoice selection")
	public void Open_InvoiceUserFields_In_All_Invoices_List_screen() {
	...
	@Test(priority = 16, description ="Open Assign Invoice Properties in 'All Invoices' list screen without invoice selection")
	public void Open_AssignInvoiceProperties_In_All_Invoices_List_screen() { 
	...
	@Test(priority = 17, description ="Open Onguard date and CA Status in 'All Invoices' list screen without invoice selection")
	public void Open_ChangeOnguardDateandCAStatusHistory_In_All_Invoices_List_screen() {
	...
	@Test(priority = 18, description ="Open partials payments in 'All Invoices' list screen without invoice selection")
	public void Open_showPartialPayment_In_All_Invoices_List_screen() {
	...
	@Test(priority = 19, description ="Open Invoice total in 'All Invoices' list screen without invoice selection")
	public void Open_InvoiceTotal_In_All_Invoices_List_screen() {
	...
	@Test(priority = 20, description ="Open Help Page in 'All Invoices' list screen without invoice selection") 
	public void Open_HelpPage_In_All_Invoices_List_screen() { 
	...
	@Test(priority = 21, description = "Open Invoice Report in 'All Invoices' list screen with invoice selection")
	public void Open_InvoiceReport_with_InvoiceSelection() {
	...
	@Test(priority = 22, description = "Open Export to Excel in 'All Invoices' list screen with invoice selection")
	public void Open_ExporttoExcel_with_InvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 23, description = "Open Advance Search in 'All Invoices' list screen with invoice selection")
	public void Open_AdvanceSearch_with_InvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 24, description = "Open Invoice Information Screen in 'All Invoices' list screen with invoice selection")
	public void Open_CIS_with_InvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 25, description = "Open Invoice Details in 'All Invoices' list screen with invoice selection")
	public void Open_InvoiceDetails_with_InvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 26, description = "Open Make Note in 'All Invoices' list screen with invoice selection")
	public void Open_MakeNote_with_InvoiceSelection() { 
		 CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 27, description ="Open Committed Payments in 'All Invoices' list screen with invoice selection")
	public void Open_CommittedPayments_with_InvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 28, description ="Open Payment Scheme in 'All Invoices' list screen with invoice selection")
	public void Open_PaymentScheme_with_InvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 29, description ="Open Register Dispute in 'All Invoices' list screen with invoice selection")
	public void Open_RegisterDispute_with_InvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 30, description ="Open Notes History in 'All Invoices' list screen with invoice selection")
	public void Open_NotesHistory_with_InvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	  ...
	  @Test(priority = 31, description = "Open Committed Payment History in 'All Invoices' list screen with invoice selection") 
	  public void Open_CommittedPaymentHistory_with_InvoiceSelection() { 
		  CG_screen.selectDebtorinListScreen(InvNum);
	  ...
	  @Test(priority = 32, description ="Open Payment Schemes History in 'All Invoices' list screen with invoice selection")
	  public void Open_PaymentSchemesHistory_with_InvoiceSelection() { 
		  CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 33, description ="Open Disputes History in 'All Invoices' list screen with invoice selection")
	public void Open_DisputeHistory_with_InvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 34, description ="Open Invoice User Fields in 'All Invoices' list screen with invoice selection")
	public void Open_InvoiceUserFields_with_InvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	 ...
	 @Test(priority = 35, description ="Open Assign Invoice Properties in 'All Invoices' list screen with invoice selection")
	 public void Open_AssignInvoiceProperties_with_InvoiceSelection() throws InterruptedException { 
		 Thread.sleep(5000);
		 CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 36, description ="Open Change Onguard date and CA Status in 'All Invoices' list screen with invoice selection")
	public void Open_ChangeOnguardDateandCAStatusHistory_with_InvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 37, description ="Open Partial payments in 'All Invoices' list screen with invoice selection")
	public void Open_showPartialPayment_with_InvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 38, description ="Open Invoice totals in 'All Invoices' list screen with invoice selection")
	public void Open_InvoiceTotal_with_InvoiceSelection() {
		CG_screen.selectDebtorinListScreen(InvNum);
	...
	@Test(priority = 39, description = "Close 'All Invoices'list screen")
	public void Close_AllInvoicesListscreen() {
		CG_screen.CloseAllCustomerGroupListScreen();
	}
