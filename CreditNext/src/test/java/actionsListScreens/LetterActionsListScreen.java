...
public class LetterActionsListScreen extends TestListenerAdapter {
	WebDriver driver = null;
	CustomeGroupsListScreenPage CG_screen = null;
	String noRowsSelected = "You must select at least one row";
	String debtID = "1097134";

	@Test(priority = 1, description = "Open Letter Actions list screen")
	public void Open_letterActionsListScreen() {
		driver = WebDriverManager.getDriverInstance();
		CG_screen = new CustomeGroupsListScreenPage(driver);
		String ExpectedResult = CG_screen.OpenCustomerGroupsListScreen(ListScreenLocators.letteractionsMenuItem);
		CG_screen.ValidateOpenedListScreen(ExpectedResult, "Letter actions");
	}

	@Test(priority = 2, description = "Open Export to Excel in 'Letter Actions' list screen without debtor selection")
	public void Open_ExporttoExcel_In_Letter_actions_List_screen() {
	...
	@Test(priority = 3, description = "Open Advance Search in 'Letter Actions' list screen without debtor selection")
	public void Open_AdvanceSearch_In_Letter_actions_List_screen() {
	...
	@Test(priority = 4, description = "Open Delete Actions in 'Letter Actions' list screen without debtor selection")
	public void Open_DeleteActions_In_Letter_actions_List_screen() {
	...
	@Test(priority = 5, description = "Open Customer Information Screen in 'Letter Actions' list screen without debtor selection")
	public void Open_CIS_In_Letter_actions_List_screen() {
	...
	@Test(priority = 6, description = "Open Bulk send to Collection Agency in 'Letter Actions' list screen without debtor selection")
	public void Open_BulkSendToCollectionAgency_In_Letter_actions_List_screen() {
	...
	public void Open_ExporttoExcel_In_Letter_actions_DebtorSelection() {
	...
	@Test(priority = 9, description = "Open Advance Search in 'Letter Actions' list screen with debtor selection")
	public void Open_AdvanceSearch_In_Letter_actions_DebtorSelection() {
		CG_screen.selectDebtorinListScreen(debtID);
		String ExpectedResult = CG_screen.OpentoolBarIconInCustonerGroupsListScreen(ListScreenLocators.advanceSearchIcon, ListScreenLocators.windowTitleText);
		CG_screen.ValidateOpenedListScreen(ExpectedResult, "Advanced search");
		CG_screen.closeModelDialog();
	}
	@Test(priority = 10, description = "Open Delete Actions in 'Letter Actions' list screen without debtor selection")
	public void Open_DeleteActions_In_Letter_actions_DebtorSelection() {
		CG_screen.selectDebtorinListScreen(debtID);
	...
	@Test(priority = 11, description = "Open Customer Information Screen in 'Letter Actions' list screen with debtor selection")
	public void Open_CIS_In_Letter_actions_DebtorSelection() {
		CG_screen.selectDebtorinListScreen(debtID);
	...
	@Test(priority = 12, description = "Open Bulk Send to Collection Agency in 'Letter Actions' list screen without debtor selection")
	public void Open_BulkSendToCollectionAgency_In_Letter_actions_DebtorSelection() {
		CG_screen.selectDebtorinListScreen(debtID);
		String ExpectedResult = CG_screen.OpentoolBarIconInCustonerGroupsListScreen(ListScreenLocators.bulkSendToCollectionAgencyIcon, ListScreenLocators.noRowsSelected);
		CG_screen.ValidateOpenedListScreen(ExpectedResult, "Please select collection agency actions");
	}
	
	@Test(priority = 13, description = "Close 'Letter Actions' list screen.")
	public void Close_letterActionsListScreen() {
