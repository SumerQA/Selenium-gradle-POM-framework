...
public class Login extends TestListenerAdapter {	
	...
	Onguard_Application_Manager_Login OG_Login1= null;
	Onguard_Application_Manager_Login_UserGroup OG_Login2= null;
	Common c = new Common();
	@Test
	...
	public void Login_User(String Locale,String ActiveUser, String ValidPassword, String NewPassword, String UserGroup) throws Exception{
		...
		OG_Login1= PageFactory.initElements(driver, Onguard_Application_Manager_Login.class);
		OG_Login2= PageFactory.initElements(driver, Onguard_Application_Manager_Login_UserGroup.class);
