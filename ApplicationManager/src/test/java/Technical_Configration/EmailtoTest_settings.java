...
public class EmailtoTest_settings {
	Common c= new Common();
	...
	ReadXclData rddata=new ReadXclData();
	 ...
	 public void  testData() throws Exception{
		 String[][] t = rddata.readdata("TC_EmailToTest");
			for(String[] rt : t){
				 for(String val : rt){
				    arr.add(val);
				    }
	 ...
	 @Test(priority=1)
	  public void EmailtoTest_Create_icon() throws IOException, InterruptedException {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  Request_Server_Settings_page RSS_page= PageFactory.initElements(driver, Request_Server_Settings_page.class);
		  Reporter.log("________________________ Email to Test server settings Page_____________________________ ");
		  RSS_page.Clickon_Create_icon();
		  Thread.sleep(1000);
		  RSS_page.Purpose_Server_settings("Email to Test");
	  }
	  @Test(priority=2)
	  public void Select_EmailtoTest_from_Purpose() throws IOException, InterruptedException {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  Request_Server_Settings_page RSS_page= PageFactory.initElements(driver, Request_Server_Settings_page.class);
		  Reporter.log("Select Email to Test from ddlist");
		  RSS_page.Purpose_Server_settings("Email to Test");
		  Thread.sleep(2000);
	  }
	  @Test(priority=3)
	  ...
	  @Test(priority=15)
	  public void Validate_EmailtoTest_Settings_Fields() throws IOException, InterruptedException {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  Request_Server_Settings_page RSS_page= PageFactory.initElements(driver, Request_Server_Settings_page.class);
		  ...
		  Thread.sleep(500);
		  Reporter.log("Enter Email to Test name");
	  ...
	  @Test(priority=19)
	  public void Validate_EmailtoTest_Server_Username_mandatory_Fields() throws IOException, InterruptedException {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  Request_Server_Settings_page RSS_page= PageFactory.initElements(driver, Request_Server_Settings_page.class);
		  Reporter.log("Enter Email to Test name");
		  RSS_page.Name(arr.get(1));
	  ...
	  public void SetUp_Basic_EmailToTest_server_settings_Configration() throws IOException, InterruptedException {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  Request_Server_Settings_page RSS_page= PageFactory.initElements(driver, Request_Server_Settings_page.class);
	 ...
	 // @Test(priority=26)
	  public void SetUp_Google_EmailToTestt_server_settings_Configration() throws IOException, InterruptedException {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  Request_Server_Settings_page RSS_page= PageFactory.initElements(driver, Request_Server_Settings_page.class);
		  Email_Servers_page ES_page= PageFactory.initElements(driver, Email_Servers_page.class);
		  RSS_page.Clickon_Create_icon();
		  ...
		  Reporter.log("Enter Description - ");
		  RSS_page.Description("Email to Test server settings for Google");
		  Reporter.log("Enter Polling Interval - ");
		  RSS_page.polling_interval(arr.get(2));
		  Reporter.log("Select Authentication Type - ");
	 ...
	 // @Test(priority=27)
	  public void SetUp_Microsoft_EmailToTestt_server_settings_Configration() throws IOException, InterruptedException {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  Request_Server_Settings_page RSS_page= PageFactory.initElements(driver, Request_Server_Settings_page.class);
		  Email_Servers_page ES_page= PageFactory.initElements(driver, Email_Servers_page.class);
		  RSS_page.Clickon_Create_icon();
	  ...
	  @Test(priority=28)
	  public void Delete_EmailtoTest_server() throws IOException, InterruptedException {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  Request_Server_Settings_page RSS_page= PageFactory.initElements(driver, Request_Server_Settings_page.class);
