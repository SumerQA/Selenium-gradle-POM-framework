...
public class Application_Manager_Login {
	Common c = new Common();
	//WebDriverManager mgr = new WebDriverManager();
	  ArrayList<String>arr= new ArrayList<>();
	  List<String> list = new ArrayList<>();
	final WebDriver driver;
	public  Application_Manager_Login(WebDriver driver)
	{   
		this.driver = driver;
	}
	...
	public Application_Manager_Login_UserGroup FormSubmission(String locale) throws Exception {	
		 ...
		 return PageFactory.initElements(driver, Application_Manager_Login_UserGroup.class);
	}
