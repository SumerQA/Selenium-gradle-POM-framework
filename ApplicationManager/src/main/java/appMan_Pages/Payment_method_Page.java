...
public class Payment_method_Page {
	...
	{   
	 ...
	 public void Goto_Payment_method_page() throws IOException, InterruptedException {	
		...
		Thread.sleep(500);*/
		FC_page.Click_on_Payment_method_tab();
		Thread.sleep(1500);
	 ...
	 public void Payment_method_name(String path, String text) throws IOException{
			events eve = new events(driver);
